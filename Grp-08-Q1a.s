	AREA q1a, CODE, READONLY
	ENTRY
	
	LDR R0, =list 		; address of array
...
pass					; then go to the pass loop and finish
	B pass
...
; the procedure bfs a subtree rooted with node i is an index in array
bfs PROC
	PUSH {LR}
								; R3 is smallest
recursion 
...
find_loop
	...
	ADD R2, R2, #1				; i++
	B find_loop					; else keep going the loop
...
list DCD 15 , 10, 5, 30, 78, 2, 19, 11, 23, 48, 79, 1, 14, 9, 41, 31
	END
		
;REMEMBER TO ADD the following 3 MEMORY WHILE DEBUGGING
; 0xf0000000, 0xf0ffffff exec read write
; 0x00000000, 0x0000ffff exec read write
; 0xfffff000, 0xffffffff exec read write